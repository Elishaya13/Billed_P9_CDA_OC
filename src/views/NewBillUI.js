            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" accept="image/jpg, image/png, image/jpeg" class="form-control blue-border" data-testid="file" />
                    <div id="fileErrorMessage" data-testid="fileErrorMessage" style="color: red;"></div>
                  </div>
                </div>
            </div>
            <div class="row">
